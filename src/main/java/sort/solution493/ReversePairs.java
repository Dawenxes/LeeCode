...
public class ReversePairs {
    ...
    private int mergeSort(int[] nums, int left, int right) {
        ...
        return merge(nums, left, right, mid) + n1 + n2;
    }
